...
- [ADR-0007: Continuous analysis runs in a process of its own](0007-analysis-engine-owns-its-own-pipe.md) — *Proposed; the original six open questions are resolved into decisions 7–15, three narrower ones remain*
