...
- [ADR-0016: The Review menu holds no state](0016-the-review-menu-holds-no-state.md) — *Accepted; implemented. Applies ADR-0012 to the prisoner counts, which were in three places at once and invisible on four of six shaders*
