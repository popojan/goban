...
const vec4 bnx = vec4(-c.x,-0.001,-c.x,0.0);
const float mw = 0.85;
...
//const Material mBoard = Material(idBoard, 0.7, 0.05, 0.25, 0.0, 0.0, 32.0, vec3(0.48826, 0.328209, 0.228209), vec3(0.587763, 0.589191, 0.4761), vec3(0.658005, 0.580002, 0.405744), 0.5);
